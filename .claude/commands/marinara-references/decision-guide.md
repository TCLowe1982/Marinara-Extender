...
See `lorebooks.md` for entry fields and tuning.
...
See `custom-tools.md` for the webhook pattern.
...
See `custom-tools.md` for full execution type breakdown.
...
See `agents.md` for phases, default prompts, custom agent creation.
...
See `extensions.md` for the API surface.
