...
**Pointing Marinara at the proxy:** set the connection's base URL to `http://127.0.0.1:3001/proxy/v1` (Custom / OpenAI-compatible) or `http://127.0.0.1:3001/anthropic/v1` (native Anthropic). Keep the **Agents / Images / Videos** default connections pointed **directly** at the provider — see `kxk`.
