...
powershell -NoLogo -ExecutionPolicy Bypass -Command ^
  ...
  "Add-Content -Path logs\sidecar.log -Value ('===== session start ' + (Get-Date -Format 'yyyy-MM-dd HH:mm:ss') + ' =====');" ^
  "node dist/index.js 2>&1 | Tee-Object -FilePath logs\sidecar.log -Append"
